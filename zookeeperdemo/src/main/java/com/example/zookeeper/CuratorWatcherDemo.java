...
public class CuratorWatcherDemo {
    ...
    public static void main(String[] args) throws Exception {
        CuratorFramework curatorFramework= CuratorFrameworkFactory.
                builder().connectString("192.168.182.128:2181,192.168.182.128:2181,192.168.182.128:2181").
        ...
        //当前节点的创建和删除事件监听
        addListenerWithNodeCache(curatorFramework,"/zl");
        //子节点的增加、修改、删除的事件监听
        addListenerWithPathChildCache(curatorFramework,"/zl");

        //综合节点监听事件
        addListenerWithTreeCache(curatorFramework,"/zl");
        System.in.read();
    }
